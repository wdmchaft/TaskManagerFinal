...
// in simulator we redefine to format for TaskManagerFinal Developer console
...
{\
	NSString * exceptionName = [@"org.taskmanagerfinal." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.taskmanagerfinal";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITaskManagerFinalNativeItemNone = -1, 
	UITaskManagerFinalNativeItemSpinner = -2,
	UITaskManagerFinalNativeItemProgressBar = -3,
	
	UITaskManagerFinalNativeItemSlider = -4,
	UITaskManagerFinalNativeItemSwitch = -5,
	UITaskManagerFinalNativeItemMultiButton = -6,
	UITaskManagerFinalNativeItemSegmented = -7,
	
	UITaskManagerFinalNativeItemTextView = -8,
	UITaskManagerFinalNativeItemTextField = -9,
	UITaskManagerFinalNativeItemSearchBar = -10,
	
	UITaskManagerFinalNativeItemPicker = -11,
	UITaskManagerFinalNativeItemDatePicker = -12,
	
	UITaskManagerFinalNativeItemInfoLight = -13,
	UITaskManagerFinalNativeItemInfoDark = -14,
	
	UITaskManagerFinalNativeItemDisclosure = -15,
	
	UITaskManagerFinalNativeItemContactAdd = -16
};
