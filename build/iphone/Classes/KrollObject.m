 ...
 * Copyright (c) 2009-2011 by TaskManagerFinal, Inc. All Rights Reserved.
...
//@interface TaskManagerFinalObject : NSObject
//@end

@interface TaskManagerFinalObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TaskManagerFinalObject class]])
		{
			for (NSString *key in [[(TaskManagerFinalObject*)o modules] allKeys])
			{
