...
@interface TaskManagerFinalObject : KrollCoverageObject {
#else
@interface TaskManagerFinalObject : KrollObject {
#endif
@private
...
extern NSString * TaskManagerFinal$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TaskManagerFinalObject *_taskmanagerfinal;
	BOOL shutdown;
